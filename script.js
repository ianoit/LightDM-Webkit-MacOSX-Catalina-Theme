...
function initialize_actions() {
    ...
    if (lightdm.can_suspend) {
        add_action("sleep","Sleep", "assets/img/sleep.svg", function(e) {lightdm.suspend(); e.stopPropagation();}, template, parent);
    }
    if (lightdm.can_restart) {
        add_action("restart", "Restart", "assets/img/restart.svg", function(e) {lightdm.restart(); e.stopPropagation();}, template, parent);
    }
    if (lightdm.can_shutdown) {
        add_action("shutdown", "Shutdown", "assets/img/shutdown.svg", function(e) {lightdm.shutdown(); e.stopPropagation();}, template, parent);
    }
}
